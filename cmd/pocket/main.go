...
func newRootCommand() *cobra.Command {
	...
	rootCmd.AddCommand(newCatalogueAliasCommand("cmd"))
	rootCmd.AddCommand(newCatalogueAliasCommand("recipe"))
	...
	rootCmd.AddCommand(newSSHForwardCommand("ssh.forward", false))
	rootCmd.AddCommand(newSSHForwardCommand("ssh.foward", true))
